...
public class JoinTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<Tuple2<String, Integer>> orderSource1 = env
                .addSource(new SourceFunction<Tuple2<String, Integer>>() {
                    ...
                    public void run(SourceContext<Tuple2<String, Integer>> ctx) throws Exception {
                        while (isRunning) {
                            ...
                            Tuple2<String, Integer> tuple2 = Tuple2
                                    .of(TYPE[random.nextInt(TYPE.length)], random.nextInt(10));
        ...
        DataStreamSource<Tuple2<String, Integer>> orderSource2 = env
                .addSource(new SourceFunction<Tuple2<String, Integer>>() {
                    private volatile boolean isRunning = true;
                    private final Random random = new Random();
